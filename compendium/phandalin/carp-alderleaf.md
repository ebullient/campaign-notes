...
Lives and helps out at [Alderleaf Farm](alderleaf-farm.md) when not running around with [Pip Stonehill](pip-stonehill.md).

## Relationships

* Mother is [Quelline Alderleaf](quelline-alderleaf.md)
* Best friend is [Pip Stonehill](pip-stonehill.md)
