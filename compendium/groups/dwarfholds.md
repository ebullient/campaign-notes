...
* Mithral Hall -- **Dagnabbit Waybeard**, Queen, in Lords' Alliance
* Citadel Adbar
* Citadel Felbarr
...
Clans lead by Kings or Queens. Noble families claim direct ancestry to first dwarves crafted by [Moradin](#Moradin). Young nobles spend time in every occupation (understand clan operation). Leadership roles are then assigned based on observed character/affinity.

Dwarven stronghold is a haven from the chaos. First concern: defense. Eventually represents clan's character. Shield dwarves more likely to mix with others/dwell in surface communities.
...
```dataview
list from #group/dwarves  and "pc-logs"
```
