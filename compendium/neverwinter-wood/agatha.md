...
She is susceptible to flattery, but also overly concerned with (and vengeful toward) thieves.
...
Agatha can be persuaded to help with a successful DC 15 Charisma (Persuasion) check. The check has advantage for good RP, and can automatically succeed if bearing gifts.
...
She once protected Conyberry, but has drifted farther into loneliness and isolation.

## Secrets

Agatha is well informed and a capable diviner, so she can answer almost any single question pertaining to the adventure that the characters think to ask. 

- She once possessed a magical mask, which could change the appearance of a person into any other race. It was stolen, and she is still bitter about it.
- Agatha traded Bowgentle's spellbook to a necromancer named Tsernoth from the city of Iriaebor more than a hundred years ago. She does not know what became of the book afterward. (Her answer is truthful)
