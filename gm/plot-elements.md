...
Growing by leaps and bounds as dwarves resettle in Axeholm. The Miner's Exchange remains the key arbiter of claims in the surrounding area (as agreed by Lords' Alliance).
...
* Zombies (Myrkul) attack Wayside Inn filled with members of Cult of Talos
* Cult of Talos attacks/tries to destroy Leilon
* Spies in Phandalin (Talos & Myrkul)
* The local cultists attempt to turn the Wayside Inn into (the first) shrine to Talos on the High Road
* Quest at House of Thalivar -- needed later
...
- [x] Cryovain
- [ ] Anchorites of Talos
    - [x] [gorthok](../compendium/bestiary/gorthok.md)
...
- [ ] Cult of Myrkul / Cult of the Dragon
    - [ ] Ularan Mortus
